...
resource "aws_ecs_service" "this" {
  ...
  # Ignore desired_count changes managed by autoscaling
  lifecycle {
...
# ---------------------------------------------------------------------------
# CloudWatch Alarms — CPU / RAM guardrails
# ---------------------------------------------------------------------------
...
resource "aws_cloudwatch_metric_alarm" "cpu_high" {
  ...
  alarm_description   = "CPU utilisation exceeded ${var.cpu_alarm_threshold}% for ${var.service_name}"
...
resource "aws_cloudwatch_metric_alarm" "memory_high" {
  ...
  alarm_description   = "Memory utilisation exceeded ${var.memory_alarm_threshold}% for ${var.service_name}"
  treat_missing_data  = "notBreaching"
